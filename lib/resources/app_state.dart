...
class AppState with ChangeNotifier {
  ...
  List<ParkingSpace> tempSpaces = [
    ...
    ...tempRow('Lot9', 1415, 1323, 1, 34, 1, type: SpaceType.handicapR),
    ...tempRow('Lot9', 1385, 1302, 1, 35, 1, type: SpaceType.handicap),
    ...tempRow('Lot9', 1370, 1291, 1, 36, 1),
    ...tempRow('Lot9', 1350, 1275, 1, 37, 1, type: SpaceType.handicapR),
    ...tempRow('Lot9', 1320, 1254, 1, 38, 1, type: SpaceType.handicap),
    ...tempRow('Lot9', 1305, 1238, 1, 39, 1, type: SpaceType.handicapR),
    ...tempRow('Lot9', 1275, 1216, 1, 40, 1, type: SpaceType.handicap),
    ...tempRow('Lot9', 1260, 1200, 1, 41, 1),
    ...tempRow('Lot9', 1240, 1183, 1, 42, 1, type: SpaceType.handicapR),
    ...tempRow('Lot9', 1210, 1164, 1, 43, 1, type: SpaceType.handicap),
//spaces to compensate differences in space sizes in a row for lot 9 as seen from google maps.
    ...tempRow('Lot9', 1335, 1445, 1, 38, 1),
    ...tempRow('Lot9', 1352, 1453, 1, 37, 1),
    ...tempRow('Lot9', 1363, 1461, 1, 36, 1),
    ...tempRow('Lot9', 1378, 1471, 1, 35, 1),
    ...tempRow('Lot9', 1393, 1480, 1, 34, 1),
  ]; // added to firestore @ 10/17/22
